...
<div class="all">
	...
	<form action="Update.action" method="post">
			...
			<table>
				...
				<tr>
					...
					<td><input type="radio" name="gender" value="1"
						${employeedata.gender==1? "checked":""}>男性 <input
						type="radio" name="gender" value="2"
						${employeedata.gender==2? "checked":""}>女性 <input
						type="checkbox" name="foreign_nationality" value="1"
						${employeedata.foreign_nationality==1? "checked":""}>外国籍</td>
				</tr>

				<tr>
					<th>生年月日</th>
					<td><input type="text" name="birthday" class="box"
				...
				<tr>
					<th>基本給料</th>
					<td><input type="text" name="base_salary" class="box" 
		...
		<div class="center">
					<div class="update">
						<input type="submit" value="更新" class="botun" data-action="update">
					</div>
			</form>
			...
			<div class="delete">
				<form action="Delete.action" method="post">
					<input type="hidden" name="hidden_employee_id"
						...
						value="削除" class="botun" data-action="delete">
				</form>
			</div>
